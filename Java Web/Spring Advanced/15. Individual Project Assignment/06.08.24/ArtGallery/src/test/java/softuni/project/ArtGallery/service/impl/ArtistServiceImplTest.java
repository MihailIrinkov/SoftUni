...
//        Assertions.assertNotEquals(ArtistDetailsViewModel.class,
//                mockModelMapper.map(artist, ArtistDetailsViewModel.class));

        ArtistDetailsViewModel details = serviceToTest.getDetails(artist.getId());
