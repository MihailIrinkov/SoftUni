...
public class Employee {
    ...
    public void printNameDepartmentAndSalary() {
...
//                this.firstName, this.lastName, this.department.getName(), this.salary);
    ...
    public void printNameProjectsJobTitle() {
        System.out.printf("%s %s - %s%n%s",
                this.firstName, this.lastName, this.jobTitle,
                projects.stream().map(p -> p.getName()).sorted()
                        .collect(Collectors.joining(System.lineSeparator())));
    }

    public void printNamesAndUpdatedSalary() {
